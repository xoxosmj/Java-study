...
public class Salary {
	...
	public static void main(String[] args) {
		...
		int sum = normal + incentive;
		int tax= (int)(sum*0.03);
		int salary = sum-tax; 
		System.out.println();
		System.out.println("*** "+name+" "+rank+" 월급***");
		/*
		System.out.println("기본급 : "+new DecimalFormat().format(normal)+"원");
		System.out.println("수당 : "+new DecimalFormat().format(incentive)+"원");
		...
		System.out.println("기본급 : "+df.format(normal)+"원");
		System.out.println("수당 : "+df.format(incentive)+"원");
